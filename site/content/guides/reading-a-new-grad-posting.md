...
"New Grad", "University Grad", "Campus", "Early Career" and a cohort year ("2027 Start") are the strongest signals. Large employers open next-year cohorts well ahead of the start date, so a 2027 posting in the autumn of 2026 is normal, not a typo.

## Phrases that look junior but are not

- "Program Manager", "Product Manager" and anything with "Lead" are excluded by default, because in most companies those are not entry roles. The exception the board keeps is "Associate Product Manager".
- "Engineer II/III" hires at both levels and stays in scope; "Engineer III" alone does not.
- "5+ years", "8+ years" and similar experience floors rule a posting out regardless of the title.

## Internships by another name

Co-ops, "student" placements and banking "summer analyst" and "summer associate" programs are internships. They are useful, but they are not new grad jobs, and this board leaves them out.
