...
The VISA / CITIZENSHIP chips split the board into "no restriction stated" and "restriction stated". The "no restriction stated" view has its own [RSS feed](../../feeds/no-visa-restriction.xml) and [landing page](../../jobs/no-visa-restriction/), so you can watch only the roles that at least do not rule you out.

## What to say in the application

Answer sponsorship questions truthfully and specifically ("I am on F-1 with STEM OPT through 2029 and would need H-1B sponsorship after that"). A precise answer is easier for a recruiter to act on than a vague one, and it avoids a withdrawn offer later.
