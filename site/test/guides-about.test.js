...
describe('aboutFacts / renderAboutPage', () => {
  const health = {
    ...
    active_hiring_companies: 290, run_duration_seconds: 151.7, url_safety_blocked: 0,
  ...
  it('derives every figure from health.json and the generated data', () => {
    ...
    expect(facts).toMatchObject({
      ...
      activeHiringCompanies: '290', enabledSources: '5', runDurationSeconds: '151.7', urlSafetyBlocked: '0',
    });
