...
- ✅ Migrate configuration from Python to `config.yml`.
- ✅ Build automated CI/CD checks for Copilot environments.
- ✅ Define strict Architectural Taboos to prevent bloat.
- ✅ Implement `make setup` and a 3-Tier Onboarding workflow.
